...
*/
let newExclaimTwo = (str) => `${str.toUpperCase()}!!!`;
console.log(newExclaimTwo("hi"));
...
const nameGreeting = nameCheck("Nick");
////////////////// PROBLEM 11 ////////////////////
/*
...
function emailCheck(email) {
  let trimmedEmail = email.trim().split("");

  let at = trimmedEmail.filter((a) => a === "@");
  console.log(at);
  if (at[0]) {
...
console.log(emailCheck("chiemekagmail.com "));
////////////////// PROBLEM 19 ////////////////////
/*
...
const totalFrogs2 = frogBuyer2(4);
console.log(totalFrogs2);

//myfirst solution
// function frogBuyer3(gold) {
//   let frogs = 0;
...
//   return frogs;
// }
// const totalFrogs3 = frogBuyer3(12);
...
const arrayIsAscending = arrDirection(sampleArray);
